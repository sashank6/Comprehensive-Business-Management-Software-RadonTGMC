<%-- 
    Document   : admin_view_po
    Created on : 20 Mar, 2013, 9:45:15 PM
    Author     : Aneesh
--%>
    ...
    int x;
          ...
          while(rs.next())
          {
             ...
             out.println(companyname);
              ...
              out.println("<td>");
              if(x<2)
                  out.println("<input type=\"button\" value=\"Cancel Order\" onclick=\"fun(\'"+gui+"\',"+x+","+useridd+","+pricree*qty+")\"/>");
              else
         ...
         <script type="text/javascript">
            function fun(order,status,vid,tv)
            {
                var p=$.ajax({
                type:"POST",
                url:"cancel_po",
                async:false,
                dataType:"html",
                data:{poid:order,status:status,vid:vid,tv:tv}
                }).responseText;
                alert(p);
                window.location="admin_view_po.jsp";
